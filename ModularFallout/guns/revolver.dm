...
/obj/item/gun/ballistic/revolver/fallout/detective
...
/obj/item/gun/ballistic/revolver/fallout/revolver45
...
// .357 REVOLVERS //
////////////////////
/obj/item/gun/ballistic/revolver/fallout/mateba //this still needs to exist for code reasons
/obj/item/gun/ballistic/revolver/fallout/golden //this still needs to exist for code reasons
/obj/item/gun/ballistic/revolver/fallout/reverse //this still needs to exist for code reasons
/obj/item/gun/ballistic/revolver/fallout/nagant //this still needs to exist for code reasons


//357 Magnum					Keywords: .357, Single action, 6 rounds cylinder, long barrel
/obj/item/gun/ballistic/revolver/fallout/colt357
...
/obj/item/gun/ballistic/revolver/fallout/colt357/mateba //this is a skin that rigbe wanted
...
/obj/item/gun/ballistic/revolver/fallout/colt357/lucky
	name = "Lucky"
...
/obj/item/gun/ballistic/revolver/fallout/police
...
/obj/item/gun/ballistic/revolver/fallout/m29/peacekeeper
	name = "Peacekeeper"
...
/obj/item/gun/ballistic/revolver/fallout/m29/peacekeeper/ui_action_click()
	burst_select()

/obj/item/gun/ballistic/revolver/fallout/m29/peacekeeper/proc/burst_select()
...
/obj/item/gun/ballistic/revolver/fallout/m29/snub
...
/obj/item/gun/ballistic/revolver/fallout/revolver44
...
/obj/item/gun/ballistic/revolver/fallout/revolver44/desert_ranger
...
/obj/item/gun/ballistic/revolver/fallout/sequoia/bayonet
...
/obj/item/gun/ballistic/revolver/fallout/sequoia/death
...
/obj/item/gun/ballistic/revolver/fallout/hunting
...
/obj/item/gun/ballistic/revolver/fallout/hunting/klatue
...
/obj/item/gun/ballistic/revolver/fallout/revolver45/gunslinger
...
/obj/item/gun/ballistic/revolver/fallout/thatgun
	name = ".223 pistol"
...
Currently broken, pending a rewrite
...
/obj/item/gun/ballistic/revolver/fallout/needler/ultra
...
/obj/item/gun/ballistic/revolver/fallout/russian
...
/obj/item/gun/ballistic/revolver/fallout/russian/do_spin()
	. = ..()
	spun = TRUE

/obj/item/gun/ballistic/revolver/fallout/russian/Initialize()
	. = ..()
	do_spin()
	spun = TRUE
	update_icon()

/obj/item/gun/ballistic/revolver/fallout/russian/attackby(obj/item/A, mob/user, params)
	..()
	if(get_ammo() > 0)
		spin()
		spun = TRUE
...
/obj/item/gun/ballistic/revolver/fallout/russian/attack_self(mob/user)
	if(!spun)
		spin()
		spun = TRUE
		return
...
/obj/item/gun/ballistic/revolver/fallout/russian/afterattack(atom/target, mob/living/user, flag, params)
...
/obj/item/gun/ballistic/revolver/fallout/russian/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0, stam_cost = 0)
...
/obj/item/gun/ballistic/revolver/fallout/russian/proc/shoot_self(mob/living/carbon/human/user, affecting = BODY_ZONE_HEAD)
...
/obj/item/gun/ballistic/revolver/fallout/russian/soul
	name = "cursed Russian revolver"
	desc = "To play with this revolver requires wagering your very soul."

/obj/item/gun/ballistic/revolver/fallout/russian/soul/shoot_self(mob/living/user)
	..()
...
/*SLING CODE
/obj/item/gun/ballistic/revolver/fallout/doublebarrel/improvised/attackby(obj/item/A, mob/user, params)
	..()
...
/obj/item/gun/ballistic/revolver/fallout/doublebarrel/improvised/update_overlays()
	. = ..()
	if(slung)
		. += "[icon_state]sling"

/obj/item/gun/ballistic/revolver/fallout/doublebarrel/improvised/sawoff(mob/user)
	. = ..()
...
//BREAK ACTION CODE
/obj/item/gun/ballistic/revolver/fallout/doublebarrel/attack_self(mob/living/user)
	var/num_unloaded = 0
	while (get_ammo() > 0)
...
//DODGE CODE
/obj/item/gun/ballistic/revolver/fallout/colt357/lucky/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
...
/obj/item/gun/ballistic/revolver/fallout/mws
...
/obj/item/gun/ballistic/revolver/fallout/mws/examine(mob/user)
	. = ..()
	. += "<span class='notice'>Alt-click to remove the magazine.</span>"

/obj/item/gun/ballistic/revolver/fallout/mws/shoot_with_empty_chamber(mob/living/user as mob|obj)
...
/obj/item/gun/ballistic/revolver/fallout/mws/process_chamber(mob/living/user)
...
/obj/item/gun/ballistic/revolver/fallout/mws/proc/switch_to(obj/item/ammo_casing/mws_batt/new_batt, mob/living/user)
	if(ishuman(user))
...
/obj/item/gun/ballistic/revolver/fallout/mws/attack_self(mob/living/user)
	if(!chambered)
		return
...
/obj/item/gun/ballistic/revolver/fallout/mws/AltClick(mob/living/user)
	.=..()
	if(magazine)
...
/obj/item/gun/ballistic/revolver/fallout/mws/update_overlays()
	.=..()
	if(!chambered)
		return
...
/obj/item/gun/ballistic/revolver/fallout/reverse/can_trigger_gun(mob/living/user)
